...
#                 # Print user login success for debugging
#                 print(f"User '{user.username}' logged in successfully.")  # Debug: User login success
#                 logger.info(f"User '{user.username}' logged in successfully.")  # Log user login success

#                 # Redirect to the dashboard or home page
#                 return redirect('userprofile:dashboard')
#             else:
#                 # Print authentication error for debugging
#                 print("Invalid credentials. Please try again.")  # Debug: Invalid credentials
#                 logger.error(f"Failed login attempt for username: {username}. Invalid credentials.")  # Log error
